...
TODO:
V1 and V2 takes the same commands, but V2 uses a TCP connection where V1 used an UDP.
For controlling v1 w/o recompiling, a startup question needs to be added, and of course
use the right type of connection.
main.v1.rar is the untouched code for v1 drones.